...
<html lang="en">
    ...
    <body class="bg-secondary">
        <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
            <a class="navbar-brand" href="U_teller.php">BDC
            </a>
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav mr-auto">
                    <li class="nav-item">
                        <a class="nav-link" href="U_teller.php">Home<span class="sr-only">(current)</span></a>
                    </li>
                ...
                <table class="table  bg-white table-bordered ">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                            <a class="btn btn-success" href='transaction.php?trans=".$row["id"].' role="button">Transact</a>
                                <a class="btn btn-primary" href="edit.php?edit=<?php echo $row['id'];?>" role="button">Edit </a>
                            </td>
                        </tr>
                        <?php endwhile;?>
                    </tbody>
