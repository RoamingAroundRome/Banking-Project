            ...
            <div class="col-lg-5 bg-light mt-5 px-0">
                ...
                <form action="C_register_process.php" method="POST" class="p-4">
                    ...
                    <div class="form-group">
                        ...
                        <input type="password" name="password" class="form-control" placeholder="Enter Password" aria-describedby="helpId" minlength="8">   
                    ...
                    <div class="form-group">
                        ...
                        <input type="decimal" name="balance" class="form-control" placeholder="Enter Balance" aria-describedby="helpId">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        <input type="submit" name="Reg_Cust" class="btn btn-primary btn-block">
                    </div>
                </form>
            </div>
        </div>
