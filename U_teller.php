    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-lg-5 bg-light mt-5 px-0">
                <h3 class="text-center text-dark p-3">Welcome Teller</h3>
            </div>
        </div>
        <div class="row justify-content-center">
            <div class="col-lg-5 bg-light ">
                <h3 class="text-center text-dark p-3">Select Action:</h3>
                <ul class="navbar-nav text-center text-dark p-3">
                    <li class="nav-item">
                        <a class=" btn btn-primary my-2 my-sm-0"  href="href="view_customer_teller.php>View Customers</a>
                    </li>
                </ul>
            </div>
        </div>
